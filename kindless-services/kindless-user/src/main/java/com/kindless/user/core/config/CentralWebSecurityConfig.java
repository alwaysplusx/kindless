package com.kindless.user.core.config;

import com.kindless.apis.support.AjaxAuthenticationHandler;
import com.kindless.apis.support.HttpHeaderSecurityTokenExtractor;
import com.kindless.user.user.userdetails.IdentityUserDetailsService;
 ...
 */
@EnableWebSecurity
public class CentralWebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    @Autowired
    public CentralWebSecurityConfig(IdentityUserDetailsService userDetailsService, JwtTokenGenerator jwtTokenGenerator) {
